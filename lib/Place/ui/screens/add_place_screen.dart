...
import 'package:platzi_trip_app/Place/ui/widgets/text_form_input_location.dart';
...
import 'package:platzi_trip_app/widgets/text_form_input.dart';
...
class _AddPlaceScreenState extends State<AddPlaceScreen> {
  ...
  void saveForm(UserBloc userBloc) {
    ...
    if (currentUser != null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("No se pudo guardar el place."),
        ),
      );
    }
  }
              ...
              child: ListView(
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: TextFormInputLocation(
                      hintText: "Add Location",
                      iconData: Icons.location_on,
                      controller: controllerLocationPlace,
                      validatorMessage: 'Please enter some location',
                    ),
                  ),
                  SizedBox(
                    width: 70.0,
